...
public:
    ...
    {
        if (elements.empty()) return ;  // empty鐨凷List涓嶈兘check, 鍥犱负stealed鐨勬椂鍊欏凡缁忔竻闄heck_.
...
private:
    ...
    struct SkipLayer
    {
        ...
        std::size_t head_offset_ = 0;  // begin璺濈head鐨勮窛绂�
        std::size_t tail_offset_ = 0;  // end璺濈tail鐨勮窛绂�
    };
